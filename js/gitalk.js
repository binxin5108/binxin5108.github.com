                ...
                function buildDistanceInWordsLocale () {
                    ...
                    function localize (token, count, options) {
                        ...
                        if (typeof distanceInWordsLocale[token] === 'string') {
                            ...
                            result = distanceInWordsLocale[token].other.replace('', count)
                        }
            ...
            /***/ (function(module, exports) {
                ...
                function declension (scheme, count) {
                    ...
                    if (rem10 === 1 && rem100 !== 11) {
                        return scheme.singularNominative.replace('', count)

                        // 2, 3, 4, 22, 23, 24, 32 ...
                    } else if ((rem10 >= 2 && rem10 <= 4) && (rem100 < 10 || rem100 > 20)) {
                        return scheme.singularGenitive.replace('', count)

                        // 5, 6, 7, 8, 9, 10, 11, ...
                    } else {
                        return scheme.pluralGenitive.replace('', count)
                    }
                }
                ...
                function buildDistanceInWordsLocale () {
                    var distanceInWordsLocale = {
                        lessThanXSeconds: buildLocalizeTokenFn({
                            regular: {
                                one: 'меньше секунды',
                                singularNominative: 'меньше  секунды',
                                singularGenitive: 'меньше  секунд',
                                pluralGenitive: 'меньше  секунд'
                            },
                            future: {
                                one: 'меньше, чем через секунду',
                                singularNominative: 'меньше, чем через  секунду',
                                singularGenitive: 'меньше, чем через  секунды',
                                pluralGenitive: 'меньше, чем через  секунд'
                            }
                        }),

                        xSeconds: buildLocalizeTokenFn({
                            regular: {
                                singularNominative: ' секунда',
                                singularGenitive: ' секунды',
                                pluralGenitive: ' секунд'
                            },
                            past: {
                                singularNominative: ' секунду назад',
                                singularGenitive: ' секунды назад',
                                pluralGenitive: ' секунд назад'
                            },
                            future: {
                                singularNominative: 'через  секунду',
                                singularGenitive: 'через  секунды',
                                pluralGenitive: 'через  секунд'
                            }
                        }),
                        ...
                        lessThanXMinutes: buildLocalizeTokenFn({
                            regular: {
                                one: 'меньше минуты',
                                singularNominative: 'меньше  минуты',
                                singularGenitive: 'меньше  минут',
                                pluralGenitive: 'меньше  минут'
                            },
                            future: {
                                one: 'меньше, чем через минуту',
                                singularNominative: 'меньше, чем через  минуту',
                                singularGenitive: 'меньше, чем через  минуты',
                                pluralGenitive: 'меньше, чем через  минут'
                            }
                        }),

                        xMinutes: buildLocalizeTokenFn({
                            regular: {
                                singularNominative: ' минута',
                                singularGenitive: ' минуты',
                                pluralGenitive: ' минут'
                            },
                            past: {
                                singularNominative: ' минуту назад',
                                singularGenitive: ' минуты назад',
                                pluralGenitive: ' минут назад'
                            },
                            future: {
                                singularNominative: 'через  минуту',
                                singularGenitive: 'через  минуты',
                                pluralGenitive: 'через  минут'
                            }
                        }),

                        aboutXHours: buildLocalizeTokenFn({
                            regular: {
                                singularNominative: 'около  часа',
                                singularGenitive: 'около  часов',
                                pluralGenitive: 'около  часов'
                            },
                            future: {
                                singularNominative: 'приблизительно через  час',
                                singularGenitive: 'приблизительно через  часа',
                                pluralGenitive: 'приблизительно через  часов'
                            }
                        }),

                        xHours: buildLocalizeTokenFn({
                            regular: {
                                singularNominative: ' час',
                                singularGenitive: ' часа',
                                pluralGenitive: ' часов'
                            }
                        }),

                        xDays: buildLocalizeTokenFn({
                            regular: {
                                singularNominative: ' день',
                                singularGenitive: ' дня',
                                pluralGenitive: ' дней'
                            }
                        }),
                        ...
                        aboutXMonths: buildLocalizeTokenFn({
                            regular: {
                                singularNominative: 'около  месяца',
                                singularGenitive: 'около  месяцев',
                                pluralGenitive: 'около  месяцев'
                            },
                            future: {
                                singularNominative: 'приблизительно через  месяц',
                                singularGenitive: 'приблизительно через  месяца',
                                pluralGenitive: 'приблизительно через  месяцев'
                            }
                        }),

                        xMonths: buildLocalizeTokenFn({
                            regular: {
                                singularNominative: ' месяц',
                                singularGenitive: ' месяца',
                                pluralGenitive: ' месяцев'
                            }
                        }),

                        aboutXYears: buildLocalizeTokenFn({
                            regular: {
                                singularNominative: 'около  года',
                                singularGenitive: 'около  лет',
                                pluralGenitive: 'около  лет'
                            },
                            future: {
                                singularNominative: 'приблизительно через  год',
                                singularGenitive: 'приблизительно через  года',
                                pluralGenitive: 'приблизительно через  лет'
                            }
                        }),

                        xYears: buildLocalizeTokenFn({
                            regular: {
                                singularNominative: ' год',
                                singularGenitive: ' года',
                                pluralGenitive: ' лет'
                            }
                        }),
                        ...
                        overXYears: buildLocalizeTokenFn({
                            regular: {
                                singularNominative: 'больше  года',
                                singularGenitive: 'больше  лет',
                                pluralGenitive: 'больше  лет'
                            },
                            future: {
                                singularNominative: 'больше, чем через  год',
                                singularGenitive: 'больше, чем через  года',
                                pluralGenitive: 'больше, чем через  лет'
                            }
                        }),

                        almostXYears: buildLocalizeTokenFn({
                            regular: {
                                singularNominative: 'почти  год',
                                singularGenitive: 'почти  года',
                                pluralGenitive: 'почти  лет'
                            },
                            future: {
                                singularNominative: 'почти через  год',
                                singularGenitive: 'почти через  года',
                                pluralGenitive: 'почти через  лет'
                            }
                        })
                    }
